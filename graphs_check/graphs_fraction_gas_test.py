...
file_path_27 = r"C:\Users\03950025081\Desktop\Simulações Thermobuilder\Seleção Treino_Teste\Data Fraction Test\Fraction Gas Test\fraction_27_gas_test.xlsx"
file_path_25 = r"C:\Users\03950025081\Desktop\Simulações Thermobuilder\Seleção Treino_Teste\Data Fraction Test\Fraction Gas Test\fraction_25_gas_test.xlsx"
file_path_7 = r"C:\Users\03950025081\Desktop\Simulações Thermobuilder\Seleção Treino_Teste\Data Fraction Test\Fraction Gas Test\fraction_7_gas_test.xlsx"

# Processar a plotar os histogramas:
df_27 = process_file(file_path_27)
plot_histogram(df_27, 'Histogramas - Dados Gás Test - Ref 27')

df_25 = process_file(file_path_25)
plot_histogram(df_25, 'Histogramas - Dados Gás Test - Ref 25')

df_7 = process_file(file_path_7)
plot_histogram(df_7, 'Histogramas - Dados Gás Test - Ref 7')
