...
plot_histogram(df_27, 'Histograms - Data Liquid Test - Ref 27')

df_25 = process_file(file_path_25)
plot_histogram(df_25, 'Histograms - Data Liquid Test - Ref 25')

df_7 = process_file(file_path_7)
plot_histogram(df_7, 'Histograms - Data Liquid Test - Ref 7')
