...
file_path_27 = r"C:\Users\03950025081\Desktop\Simulações Thermobuilder\Seleção Treino_Teste\Data Fraction Train\Fraction Gas Train\fraction_27_gas_train.xlsx"
file_path_25 = r"C:\Users\03950025081\Desktop\Simulações Thermobuilder\Seleção Treino_Teste\Data Fraction Train\Fraction Gas Train\fraction_25_gas_train.xlsx"
file_path_7 = r"C:\Users\03950025081\Desktop\Simulações Thermobuilder\Seleção Treino_Teste\Data Fraction Train\Fraction Gas Train\fraction_7_gas_train.xlsx"

# Processar a plotar os histogramas:
df_27 = process_file(file_path_27)
plot_histogram(df_27, 'Histogramas - Dados Gás Train - Ref 27')

df_25 = process_file(file_path_25)
plot_histogram(df_25, 'Histogramas - Dados Gás Train - Ref 25')

df_7 = process_file(file_path_7)
plot_histogram(df_7, 'Histogramas - Dados Gás Train - Ref 7')
