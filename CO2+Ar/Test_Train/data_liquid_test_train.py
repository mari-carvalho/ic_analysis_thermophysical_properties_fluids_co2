...
file_path = r"C:\Users\03950025081\Desktop\Simulações Thermobuilder\CO2+Ar\Seleção Treino_Teste\Argon Databank_DENSIDADES.xlsx"
...
features = data[['ID', 'xAr ', 'xCO2', 'T [K]', 'P [MPa]', 'ρ [kg/m3]']]
...
folder_path = r"C:\Users\03950025081\Desktop\Simulações Thermobuilder\CO2+Ar\Seleção Treino_Teste\Train_Test Liquid"
