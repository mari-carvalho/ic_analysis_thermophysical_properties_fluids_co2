...
feed_ar_20_00308 = []
feed_co2_00308 = []
temperature_20_00308 = []
pressure_20_00308 = []
experimental_20_00308 = []
...
temperature_20_0060 = []
pressure_20_0060 = []
experimental_20_0060 = []

feed_ar_20_0100 = []
feed_co2_0100 = []
temperature_20_0100 = []
pressure_20_0100 = []
experimental_20_0100 = []

feed_ar_20_0134 = []
feed_co2_0134 = []
temperature_20_0134 = []
pressure_20_0134 = []
experimental_20_0134 = []

feed_ar_20_0167 = []
feed_co2_0167 = []
temperature_20_0167 = []
pressure_20_0167 = []
experimental_20_0167 = []
...
feed_ar_20_00009 = []
feed_co2_00009 = []
temperature_20_00009 = []
pressure_20_00009 = []
experimental_20_00009 = []

feed_ar_20_00014 = []
feed_co2_00014 = []
temperature_20_00014 = []
pressure_20_00014 = []
experimental_20_00014 = []

feed_ar_20_00024 = []
feed_co2_00024 = []
temperature_20_00024 = []
pressure_20_00024 = []
experimental_20_00024 = []

feed_ar_20_00041 = []
feed_co2_00041 = []
temperature_20_00041 = []
pressure_20_00041 = []
experimental_20_00041 = []

feed_ar_20_00063 = []
feed_co2_00063 = []
temperature_20_00063 = []
pressure_20_00063 = []
experimental_20_00063 = []

feed_ar_20_00084 = []
feed_co2_00084 = []
temperature_20_00084 = []
pressure_20_00084 = []
experimental_20_00084 = []

feed_ar_20_00142 = []
feed_co2_00142 = []
temperature_20_00142 = []
pressure_20_00142 = []
experimental_20_00142 = []

feed_ar_20_00020 = []
feed_co2_00020 = []
temperature_20_00020 = []
pressure_20_00020 = []
experimental_20_00020 = []
...
feed_ar_20_00011 = []
feed_co2_00011 = []
temperature_20_00011 = []
pressure_20_00011 = []
experimental_20_00011 = []

feed_ar_20_00007 = []
feed_co2_00007 = []
temperature_20_00007 = []
pressure_20_00007 = []
experimental_20_00007 = []
...
for row in sheet.iter_rows(min_row=2, values_only=True):  # Supondo que 'data' seja a lista de dados
    ...
    if row[1] == 0.24907:
        ...
        feed_ar_20_00308.append(row[1])
        feed_co2_00308.append(row[0])
        temperature_20_00308.append(row[2])
        pressure_20_00308.append(row[3])
        experimental_20_00308.append(row[4])
        ...
        feed_ar_20_0207.append(row[1])
        feed_co2_0207.append(row[0])
        temperature_20_0207.append(row[2])
        pressure_20_0207.append(row[3])
        experimental_20_0207.append(row[4])
        ...
        feed_ar_20_0060.append(row[1])
        feed_co2_0060.append(row[0])
        temperature_20_0060.append(row[2])
        pressure_20_0060.append(row[3])
        experimental_20_0060.append(row[4])

    elif row[1] == 0.100:
        feed_ar_20_0100.append(row[1])
        feed_co2_0100.append(row[0])
        temperature_20_0100.append(row[2])
        pressure_20_0100.append(row[3])
        experimental_20_0100.append(row[4])

    elif row[1] == 0.134:
        feed_ar_20_0134.append(row[1])
        feed_co2_0134.append(row[0])
        temperature_20_0134.append(row[2])
        pressure_20_0134.append(row[3])
        experimental_20_0134.append(row[4])

    elif row[1] == 0.167:
        feed_ar_20_0167.append(row[1])
        feed_co2_0167.append(row[0])
        temperature_20_0167.append(row[2])
        pressure_20_0167.append(row[3])
        experimental_20_0167.append(row[4])
...
# caminho do arquivo:
filtered_file_path = r"C:\Users\03950025081\Desktop\Simulações Thermobuilder\CO2+Ar\Seleção Treino_Teste\Data Fraction Train\Fraction Liquid Train\fraction_20_liquid_train.xlsx"
...
for ref_value, data in [
    ...
    (0.0308, (feed_ar_20_00308, feed_co2_00308, temperature_20_00308, pressure_20_00308, experimental_20_00308)),
    (0.1694, (feed_ar_20_01694, feed_co2_01694, temperature_20_01694, pressure_20_01694, experimental_20_01694)),
    (0.207, (feed_ar_20_0207, feed_co2_0207, temperature_20_0207, pressure_20_0207, experimental_20_0207)),
    (0.248, (feed_ar_20_0248, feed_co2_0248, temperature_20_0248, pressure_20_0248, experimental_20_0248)),
    (0.060, (feed_ar_20_0060, feed_co2_0060, temperature_20_0060, pressure_20_0060, experimental_20_0060)),
    (0.100, (feed_ar_20_0100, feed_co2_0100, temperature_20_0100, pressure_20_0100, experimental_20_0100)),
    (0.134, (feed_ar_20_0134, feed_co2_0134, temperature_20_0134, pressure_20_0134, experimental_20_0134)),
    (0.167, (feed_ar_20_0167, feed_co2_0167, temperature_20_0167, pressure_20_0167, experimental_20_0167)),
